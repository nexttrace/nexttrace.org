    ...
    <Layout>
      ...
      <Box sx={{ maxWidth: "40em", my: [5] }}>
        ...
        <Text sx={{ mb: [3] }}>
          ...
          community engagement. With a centralized strategy, and through close
          partnerships with others, we can help orient that force.
        </Text>
        <Text>
      ...
      <Box sx={{ maxWidth: "40em", my: [5] }}>
        <Text>We're not doing this alone.</Text>
      </Box>
    </Layout>
  )
}
